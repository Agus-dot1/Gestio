...
exports.formatISOToDDMMYYYY = exports.parseSaleDateInputToISO = void 0;
const INPUT_REGEX = /^\d{1,2}\/\d{1,2}(\/\d{4})?$/;
function parseSaleDateInputToISO(input) {
    const trimmed = (input || '').trim();
    if (!trimmed)
        return { valid: false, error: 'Fecha vacía' };
    ...
    if (parts[2] && (year < 1900 || year > 9999))
...
exports.parseSaleDateInputToISO = parseSaleDateInputToISO;
...
exports.formatISOToDDMMYYYY = formatISOToDDMMYYYY;
